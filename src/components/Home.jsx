            ...
            <div className="nest-top-bar">
                <div className="nest2-top-bar">
                    <div className="hf-logo">
                        <a className="logo">
                            <img src="https://assets.www.happyfox.com/v2/images/site-nav/topbar-logo-black.svg" width={116} height={24} alt="" />
                        </a>
                    </div>
                    <div className="hover">
                        <span className="hf-productnav__menu-text">
                            Products
                            <img className="pointer" src="https://assets.www.happyfox.com/v2/images/site-nav/menu-togle-arrow-gray-up.png" width={7.9} height={7.9} alt="" />
                        </span>
                    </div>
                    <div className="login">
                    ...
                    <ul className="hf-productnav__menu-list">
                        <li className="hf-productnav__menu-list-item">
                            <a className="hf-productnav__menu-link">
                                <span>Features
                                    <img src="https://assets.www.happyfox.com/v2/images/site-nav/menu-togle-arrow-gray-up.png" width={10} height={10} alt="" />
                                </span>
                            </a>
                        </li>
                        <li className="hf-productnav__menu-list-item">
                            <a className="hf-productnav__menu-link">
                                <span>Solutions
                                    <img src="https://assets.www.happyfox.com/v2/images/site-nav/menu-togle-arrow-gray-up.png" width={7.9} height={7.9} alt="" />
                                </span>
                            </a>
                        </li>
                        <li className="hf-productnav__menu-list-item">
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="pricing-explainer">
                            <a className="pricing-explainer__block agent">
                                <h4 className="pricing-explainer__heading">Agent-based pricing</h4>
                            </a>
                            <a className="pricing-explainer__block volume ">
